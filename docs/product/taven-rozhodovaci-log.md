...
| 92 | **Ztracená nebo vrácená zásilka otevírá claim už ze stavu `shipped`** | bez pre-delivery incidentu nemá nedoručená zaplacená objednávka cestu k nové zásilce, přetisku ani refundu | povolit claim až po `delivered` | zpřesňuje #64, #65 a #73 |
