...
| `LateCaptureCompensation` | ✓ | ✓ | `initial_checkout_expired`, `initial_checkout_cancelled`, `initial_checkout_capacity`, `balance_settlement`, `sample_confirmation_expired` nebo `revision_rejected`; plná refundace provider capture bez znovuotevření fulfilmentu |
